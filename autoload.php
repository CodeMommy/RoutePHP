...
autoloadDirectory(sprintf('%s%ssource', __DIR__, DIRECTORY_SEPARATOR), 'CodeMommy\\RoutePHP');
autoloadDirectory(sprintf('%s%sinterface', __DIR__, DIRECTORY_SEPARATOR), 'CodeMommy\\RoutePHP');
